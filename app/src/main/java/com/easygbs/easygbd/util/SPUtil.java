...
public class SPUtil {
    ...
    public static int getBitrateKbps(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getInt(KEY_BITRATE_ADDED_KBPS,4000);
    }
    ...
    public static String getServerip(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(SERVERIP, "212.64.34.165");
    }
    ...
    public static String getDeviceid(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(DEVICEID, "34020000002000005559");
    }
    ...
    public static String getIndexcode(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(INDEXCODE,"34020000001310005554");
    }
